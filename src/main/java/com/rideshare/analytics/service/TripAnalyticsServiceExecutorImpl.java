...
@Service
public class TripAnalyticsServiceExecutorImpl implements TripAnalyticsService {

    public Map<String, BigDecimal> calculateTotalEarnings(
            final Stream<Trip> tripStream) {
        ...
        List<Future<Map<String, BigDecimal>>> results = null;
        try {
            results = executor.invokeAll(tasks);
        } catch (final InterruptedException e) {
            throw new RuntimeException(e);
        }
        final Map<String, BigDecimal> finalMap = new HashMap<>();
